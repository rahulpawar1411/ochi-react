...
const Footer = () => {
  return (
    <div data-scroll data-scroll-section data-scroll-speed=".9" className="w-full h-screen bg-[#F1F1F1] px-16 pt-16 rounded-tl-xl flex gap-10 rounded-tr-xl -mt-[20VW] ">
      <div className="relative w-[50%]">
        <div className="w-full h-1/2  leading-[6.5vw]">
          <h1 className="  text-[8vw] font-bold tracking-tighter ">EYE-</h1>
          <h1 className=" text-[8vw] font-bold tracking-tighter">OPENING</h1>
        </div>
      ...
      <div className="w-[50%] h-full ">
        <h1 className="text-[6vw]  uppercase font-bold tracking-tighter font-[Founders Grotesk]">
          presentations
        </h1>

        <div className="w-full h-[78%]  flex   ">
          <div className="w-1/2 h-full flex flex-col ">
            <div className="w-1/2 h-full  flex flex-col  leading-5 mb-5">
          ...
          <div className="w-[30%] h-full  flex flex-col items-start justify-center leading-5 mb-5">
              <h1 className="mb-5"> H:</h1>
              <a href="#">Home</a>
              <a href="#">Services</a>
              <a href="#">Our Work</a>
              <a href="#">About us</a>
