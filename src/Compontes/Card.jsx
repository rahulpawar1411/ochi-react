...
const Card = () => {
  return (
    <div data-scroll data-scroll-section data-scroll-speed="-.1" className='w-full h-screen gap-5 flex p-16'>
        <div className="cardCan w-1/2 h-96 rounded-lg overflow-hidden ">
            <div className="card relative w-full h-full bg-[#004D43] flex justify-center items-center">
                <div className='text-[#CDEA68]'>
                    <svg width="100" height="100" viewBox="0 0 72 30" fill="none" >
                 ...
                 <button className='border-[1px] border-[#CDEA68] px-2 text-[#CDEA68] absolute top-[85%] left-10 rounded-full'>©2019-2022

                 </button>
            </div>
        </div>
        <div className="cardCan w-1/2 h-96  gap-5 flex">
            <div className='w-1/2 h-full relative bg-[#212121] rounded-lg flex justify-center items-center'>
            <img src="https://ochi.design/wp-content/uploads/2022/04/logo002.svg" alt="" />
            <button className='border-[1px] border-white px-2 text-white absolute top-[85%] left-5 rounded-full'>RATING 5.0 ON CLUTCH
                    </button>
            </div>
            <div className='w-1/2 h-full relative bg-[#212121] rounded-lg flex justify-center items-center'>
                <img className='w-[30%]' src="https://ochi.design/wp-content/uploads/2022/04/logo003.png" alt="" />
                <button className='border-[1px] border-white px-2 text-white absolute top-[85%] left-5 rounded-full'>BUSINESS BOOTCAMP ALUMNI
                    </button>
            </div>
        </div>
